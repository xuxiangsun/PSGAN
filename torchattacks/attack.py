...
class Attack(object):
    ...
    def __init__(self, name, model, opt):
        ...
        self.clamodel = getattr(self.model, 'net{}'.format(self.opt.model))
        
        self.training = self.clamodel.training
        self.device = next(self.clamodel.parameters()).device
    ...
    def __call__(self, *input, **kwargs):
        self.model.eval()
        # self.model.set_input(*input, **kwargs)
