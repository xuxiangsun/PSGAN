...
class resnext101model(BaseModel):

    def __init__(self, opt):
        BaseModel.__init__(self, opt)
        self.opt = opt
        self.target_model = torchvision.models.resnext101_32x8d(pretrained=False)
        self.target_model.load_state_dict(torch.load('./pretrained/resnext101_32x8d-8ba56ff5.pth'))
        self.num_fits = self.target_model.fc.in_features
        self.target_model.fc = nn.Linear(self.num_fits, opt.classes)
        self.model_names = ['resnext101']
        ...
        self.netresnext101 = self.target_model
    ...
    def forward(self):
        self.logits = self.netresnext101(self.imgs)
